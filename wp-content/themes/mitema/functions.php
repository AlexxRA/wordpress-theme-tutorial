...
function assets() {
    ...
    wp_enqueue_script('boostraps', 'https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/js/bootstrap.min.js', array('jquery','popper'),'5.0.0', true);
...
function productos_type(){
    ...
    $args = array(
        'label'  => 'Productos', 
        'description' => 'Productos de mi tienda',
        'labels'       => $labels,
